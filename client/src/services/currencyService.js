...
function prepareFormData(data, uploadedfile){
  ...
  formData.append('price_change_24h', data.price_change_24h);
  formData.append('price_change_percentage_24h', data.price_change_percentage_24h);
  formData.append('high_24h', data.high_24h);
  formData.append('low_24h', data.low_24h);
  formData.append('status', data.status);
  formData.append('total_volume', data.total_volume);
